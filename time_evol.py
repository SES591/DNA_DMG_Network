...
def edge_print(EDGE_FILE,NODE_FILE):
    ...
    nx.write_graphml(net,"network_p53_normal_4.graphml")
    nx.write_graphml(decStateTransMap,"attractor_p53_normal_4.graphml")
    
    attractor_file = 'attractors_p53_normal_4.txt'
...
def main(argv):
    ...
    edge_print(EDGE_FILE,NODE_FILE)
